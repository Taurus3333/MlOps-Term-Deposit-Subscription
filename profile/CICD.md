...
**Result:** Task definition registered.
...
**Result:** ECS service created. It will try to run your container (will fail initially because no image exists yet).
